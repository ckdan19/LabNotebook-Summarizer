...
This file is the single source of truth for how the six GitHub notebook subagents
(`ariana-notebook-agent`, `sams-notebook-agent`, `grace-notebook-agent`,
`tumbling-oysters-agent`, `megan-notebook-agent`, `kathleen-notebook-agent`) fetch,
classify, and format post activity. Each agent
